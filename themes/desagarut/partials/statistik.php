...
$desa = $this->db->query('SELECT COUNT(id) AS jumlah FROM tweb_wilayah WHERE desa <> "-" AND desa <> "0" AND dusun = "0" AND rw = "0" AND rt = "0"')->result_array()[0]['jumlah'];
$dusun = $this->db->query('SELECT COUNT(id) AS jumlah FROM tweb_wilayah WHERE desa <> "-" AND desa <> "0" AND dusun <> "-" AND dusun <> "0"  AND rw = "0" AND rt = "0"')->result_array()[0]['jumlah'];
$rw = $this->db->query('SELECT COUNT(id) AS jumlah FROM tweb_wilayah WHERE desa <> "-" AND desa <> "0" AND dusun <> "-" AND dusun <> "0"  AND rw <> "-" AND rw <> "0" AND rt = "0"')->result_array()[0]['jumlah'];
$rt = $this->db->query('SELECT COUNT(id) AS jumlah FROM tweb_wilayah WHERE desa <> "-" AND desa <> "0" AND dusun <> "-" AND dusun <> "0"  AND rw <> "-" AND rw <> "0" AND rt <> "-" AND rt <> "0"')->result_array()[0]['jumlah'];
?>

    <!-- Facts Start -->
    <div class="container-fluid facts py-5 pt-lg-0 sm-none xs-none pull-center">
        <div class="container py-5 pt-lg-0 float-center">
            <div class="row gx-0">
                <div class="col-lg-3 wow zoomIn" data-wow-delay="0.3s">
                    <div class="bg-light shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                        ...
                        <div class="ps-4">
                            <h5 class="text-primary mb-0">Desa & Kelurahan</h5>
                ...
                <div class="col-lg-3 wow zoomIn" data-wow-delay="0.1s">
                    <div class="bg-primary shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;">
                        ...
                        <div class="ps-4">
                            <h5 class="text-white mb-0">Dusun & Wilayah</h5>
