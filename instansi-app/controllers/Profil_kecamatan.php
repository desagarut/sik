...
class Profil_kecamatan extends Admin_Controller {
	...
	public function index()
	{
		...
		$this->render('profil_kecamatan/index', $data);
	}
	...
	public function form()
	{
		...
		if ($data['main'])
			$data['form_action'] = site_url('profil_kecamatan/update/' . $data['main']['id']);
		else
			$data['form_action'] = site_url('profil_kecamatan/insert');

		$this->render('profil_kecamatan/form', $data);
	}

	public function insert()
	{
		$this->config_model->insert();
		redirect('profil_kecamatan');
	}
	...
	public function maps($tipe = 'kantor')
	{
		...
		$data['breadcrumb'] = array(
			array('link' => site_url("profil_kecamatan"), 'judul' => "Identitas " . ucwords($this->setting->sebutan_desa)),
		);

		$data['form_action'] = site_url("profil_kecamatan/update_maps/$tipe");
