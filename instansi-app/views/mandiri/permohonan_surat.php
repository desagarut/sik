            ...
            <tbody>
              ...
              <tr>
                ...
                <td nowrap align="center"><a href="#" class="btn bg-warning disabled btn-box btn-sm" >
                  ...
                  <?php endif; ?>
                  <?php if (in_array($data['status_id'], array(0, 1))): ?>
                  <a href="#" data-href="<?=site_url("{$this->controller}/delete/$data[id]")?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
                  <?php endif; ?></td>
              </tr>
              <?php endforeach; ?>
            </tbody>
