...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h5>Daftar Polling Tingkat Desa</h5>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="<?= site_url() ?>beranda">Beranda</a></li>
						<li class="breadcrumb-item"><a href="#!">Perencanaan Desa</a></li>
						<li class="breadcrumb-item active"><a href="#!">Daftar Polling</a></li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
  ...
  <section class="content" id="maincontent">
    <div class="row">
      <div class="col-md-3">
        <?php $this->load->view('layanan_masyarakat/polling/menu'); ?>
      </div>
      <div class="col-md-9">
        <div class="card">
...
<script>
	$(document).ready(function() {
		$('#example1').DataTable({
			...
			'ajax': {
				'url': "<?= site_url('layanan_masyarakat/mandiri_polling') ?>",
				'method': 'POST',
				'data': function(d) {
					d.tahun = $('#tahun').val();
				}
				...
				},
				{
					'data': function(data) {
						...
						if (data.status_vote == 1) {
							status_vote = `<a href="<?= site_url('perencanaan_desa_polling/tanggapan_per_item/') ?>${data.id}" id="status_vote" class="btn btn-sm btn-primary mb-2 mr-2" title="Polling Aktif">Beri Tanggapan</a>`
						} else {
