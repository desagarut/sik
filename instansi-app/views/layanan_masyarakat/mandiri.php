    ...
    <div class="container-fluid">
      <div class="row">
                <div class="col-md-4"> 
                  ...
                  <div class="card card-primary">
                    <div class="card-body"> <a class="btn btn-app" style="color:#06F" href="<?=site_url('arsip')?>" title="Tulis Berita"><i class="fa fa-bullhorn text-yellow"></i> Berita</a> <a class="btn btn-app" style="color:#06F" href="<?= site_url('mandiri_web/mandiri/1/3');?>" title="Pesan"><span class="badge bg-aqua"></span><i class="fa fa-envelope text-green"></i> Pesan </a> <a class="btn btn-app" style="color:#06F" href="<?= site_url('mandiri_web/mandiri/1/2');?>"> <i class="fa fa-paper-plane-o text-aqua"></i> Buat Surat</a> <a class="btn btn-app" style="color:#06F" href="<?=site_url('mandiri_web/mandiri/1/4')?>"><i class="fa fa-handshake-o text-blue"></i> <span class="badge bg-blue">
                      <?=$komentar?>
                      </span>Bantuan </a> <a class="btn btn-app" style="color:#06F" href="<?=site_url('mandiri_web/ganti_pin')?>" title="Ubah PIN "> <i class="fa fa-key"></i> Ubah PIN </a> <a class="btn btn-app" style="color:#06F" href="<?=site_url('mandiri_web/mandiri_dokumen')?>" title="Ubah PIN "> <i class="fa fa-file"></i> Dokumen </a> </div>
                  </div>
                </div>
                <div class="col-md-8"> 
                  <!--<div class="row">
          ...
          <!-- /.row -->
                  ...
                  <?php $this->load->view('layanan_masyarakat/profil/penduduk_map.php');?>
