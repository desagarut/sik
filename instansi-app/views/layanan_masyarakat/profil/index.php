              ...
              <div class="col-md-9">
                <div class="nav-tabs-custom">
                  ...
                  <div class="tab-content"> 
                    <!-- /Profile Biodata-->
                    <?php $this->load->view('layanan_masyarakat/profil/profil_biodata.php');?>
                    <!-- /Profile Keluarga-->
                    <?php $this->load->view('layanan_masyarakat/profil/profil_keluarga.php');?>
                    <!-- /Profile Pokmas-->
                    <?php $this->load->view('layanan_masyarakat/profil/profil_pokmas.php');?>
                    <!-- /Profile Dokumen-->
                    <?php $this->load->view('layanan_masyarakat/profil/profil_dokumen.php');?>
                    <!-- /Profile Program Bantuan-->
                    <?php $this->load->view('layanan_masyarakat/profil/profil_program_bantuan.php');?>
                    <!-- /Profile Rumah Tinggal-->
                    <?php $this->load->view('layanan_masyarakat/profil/profil_rumah.php');?>
                    <!-- /Profile mandiri-->
                    <?php $this->load->view('layanan_masyarakat/profil/profil_resume.php');?>
                  </div>
                </div>
              </div>
          </div>
