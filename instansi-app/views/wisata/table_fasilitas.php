  ...
  <form id="mainform" name="mainform" action="" method="post">
      ...
      <div class="card card-warning collapsed-box">
        <div class="card-header"> <i class="fa fa-calendar"></i>
          <h3 class="card-title"><strong>INFO WISATA</strong></h3>
          <!-- tools box -->
      ...
      <div class="card card-warning">
          <div class="card-header"><i class="fa fa-list"></i>
            <h3 class="card-title"><strong>DETAIL FASILITAS</strong></h3>
            <!-- tools box -->
            <div class="pull-right box-tools"> 
            <!-- button with a dropdown -->
            <div class="btn-group"> </div>
                  ...
                  <form id="mainform" name="mainform" action="" method="post">
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?= site_url("wisata/delete_all_fasilitas/$gallery")?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash'></i> Hapus Data Terpilih</a>
                        <?php endif; ?>
