	...
	<div class="page-header">
		...
		<ul class="breadcrumb">
			<li><a href="<?= site_url('beranda')?>"><i class="fa fa-home"></i> Home</a></li>
						<li class="breadcrumb-item active">Pengaturan Tipe Garis</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
          ...
          <?php $this->load->view('plan/nav.php')?>
            ...
            <div class="card-header">
							...
							<?php if ($this->CI->cek_hak_akses('h')): ?>
								<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?=site_url("line/delete_all/$p/$o")?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash'></i> Hapus Data Terpilih</a>
							<?php endif; ?>
																...
																<?php foreach ($main as $data): ?>
																	<tr>
																		...
																		<td nowrap>
																			...
																			<?php endif ?>
																			<a href="#" data-href="<?= site_url("line/delete/$p/$o/$data[id]")?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
																	  </td>
