	...
	<div class="page-header">
		...
		<ul class="breadcrumb">
			...
			<li><a href="<?= site_url('line')?>"> Daftar Tipe Garis</a></li>
						<li class="breadcrumb-item active">Pengaturan Kategori Garis</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
		...
		<form id="mainform" name="mainform" action="" method="post">
          ...
          <?php $this->load->view('plan/nav.php')?>
            ...
            <div class="card-header">
							...
							<a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?=site_url("line/delete_all_sub_line/")?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash'></i> Hapus Data Terpilih</a>
											...
											<div class="row">
												<div class="col-sm-12">
													<div class="table-responsive">
														<h5 class="card-title text-center">Daftar Kategori <?= $line['nama']; ?></h5>
																...
																<?php foreach ($subline as $data): ?>
																	<tr>
																		...
																		<td nowrap>
																			...
																			<?php endif; ?>
																			<a href="#" data-href="<?= site_url("line/delete_sub_line/$line[id]/$data[id]")?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
																	  </td>
