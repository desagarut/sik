	...
	<div class="page-header">
		...
		<ul class="breadcrumb">
			...
			<li><a href="<?= site_url('suplemen')?>"> Data Suplemen</a></li>
						<li class="breadcrumb-item active">Daftar Terdata Suplemen</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
											...
											<tr>
												...
												<td class="aksi">
													<?php if ($this->CI->cek_hak_akses('h')): ?>
														...
														<a href="#" data-href="<?= site_url("suplemen/hapus_terdata/$suplemen[id]/$item[id]"); ?>" class="btn bg-maroon btn-box btn-sm" title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
													<?php endif; ?>
												</td>
