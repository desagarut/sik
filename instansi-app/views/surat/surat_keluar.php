...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h4 class="m-0">Arsip Layanan Surat</h4>
				</div>
				<!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li><a href="<?= site_url('beranda') ?>"><i class="fa fa-home"></i> Home</a></li>
						<li class="breadcrumb-item active">Arsip Layanan Surat</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
													...
													<div class="row">
															<div class="card-header row">
																...
																<div class="form-group col-xs-3">
																	<select class="form-control input-sm select2bs" name="jenis" onchange="formAction('mainform','<?= site_url($this->controller . '/jenis') ?>')" style="width: 100%;">
																...
																?>
																	<tr>
																		...
																		<td nowrap>
																			...
																			<a href="#" data-href="<?= site_url("keluar/delete/$p/$o/$data[id]") ?>" class="btn bg-maroon btn-box btn-sm" title="Hapus Data" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
																		</td>
