...
* Urutan: (1) LOKASI_SURAT_INSTANSI/<folder_surat_ini>
*         (2) LOKASI_SURAT_FORM_INSTANSI
* Kalau tidak ada, pakai file form surat yang disediakan di release SID
* di instansi-app/surat/<folder_surat_ini>
*
 -->
<?php
	$nama_surat = $url;
  $form_surat = LOKASI_SURAT_INSTANSI . $nama_surat . "/" . $nama_surat . ".php";
  if (is_file($form_surat))
    include($form_surat);
  elseif (is_file(LOKASI_SURAT_FORM_INSTANSI . $nama_surat . ".php"))
	  include(LOKASI_SURAT_FORM_INSTANSI . $nama_surat . ".php");
	else
