...
<div class="content-wrapper">
	...
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h4 class="m-0">Pengaturan Slider</h4>
				</div>
				<!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="<?= site_url('beranda') ?>"><i class="fa fa-home"></i> Home</a></li>
						<li class="breadcrumb-item active">Statistik Pengunjung Website</li>
					</ol>
				</div>
				<!-- /.col -->
			</div>
								...
								<div class="row">
									<div class="col-lg-2 col-xs-6">
										<div class="small-box bg-red">
											...
											<a href="<?= site_url('pengunjung/detail/1') ?>" class="small-card-footer">Detail <i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>
									<div class="col-lg-2 col-xs-6">
										<div class="small-box bg-purple">
											...
											<a href="<?= site_url('pengunjung/detail/2') ?>" class="small-card-footer">Detail <i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>
									<div class="col-lg-2 col-xs-6">
										<div class="small-box bg-green">
											...
											<a href="<?= site_url('pengunjung/detail/3') ?>" class="small-card-footer">Detail <i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>
									<div class="col-lg-2 col-xs-6">
										<div class="small-box bg-yellow">
											...
											<a href="<?= site_url('pengunjung/detail/4') ?>" class="small-card-footer">Detail <i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>
									<div class="col-lg-2 col-xs-6">
										<div class="small-box bg-gray">
											...
											<a href="<?= site_url('pengunjung/detail/5') ?>" class="small-card-footer">Detail <i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>
									<div class="col-lg-2 col-xs-6">
										<div class="small-box bg-blue">
											...
											<a href="<?= site_url('pengunjung/detail/') ?>" class="small-card-footer">Detail <i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>
								</div>
								<div class="card-header">
