...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h4 class="m-0">Lokasi Kantor <?= $nama_wilayah ?></h4>
        </div>
        <!-- /.col -->
        <div class="col-sm-6">
          ...
          <form action="<?= $form_action ?>" method="post" id="validasi" enctype="multipart/form-data">
            ...
            <div class="card-footer">
              <div class="row col-sm-5">
                <a href="<?= site_url('profil_kecamatan') ?>" class="btn btn-box bg-purple btn-sm" title="Kembali"><i class="fa fa-backward"></i> Kembali</a>
