            ...
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="resume"> 
                ...
                <div class="card card-warning">
                  <div class="card-header">
                    <h3 class="card-title"><a href="#">Lokasi Rumah</a> </h3>
                    <div class="card-tools"> <span><a class="btn btn-success btn-xs" href="<?=site_url()?>gis/clear"><i class="fa fa-map-marker"></i> Peta Desa</a></span>
              ...
              <div class="card card-warning">
                <div class="card-header">
                  <h3 class="card-title"><a href="#">Foto Rumah</a></h3>
              ...
              <div class="card card-warning">
                <div class="card-header">
                  <h3 class="card-title"><a href="#bantuan">Program Bantuan</a></h3>
                  <div class="card-tools"> <span class="time"><a class="btn btn-primary btn-xs" href="<?=site_url()?>program_bantuan"><i class="fa fa-list"></i> Daftar Program Bantuan</a></span>
                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fa fa-minus"></i> </button>
                    <button type="button" class="btn btn-tool" data-card-widget="remove"><i class="fa fa-times"></i> </button>
                  </div>
                </div>
              ...
              <div class="card card-success">
                <div class="card-header">
                  <h3 class="card-title pull-right"><small>Data Awal : <i class="fa fa-clock-o"></i>
                    <?= tgl_indo2($penduduk['created_at']);?>
