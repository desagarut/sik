      ...
      <div class="row">
          <div class="col-md-12">
              <div class="card card-warning">
                ...
                <a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?= site_url("toko_warga/delete_all_produk/$gallery")?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash'></i> Hapus Data Terpilih</a>
                <?php endif; ?>
...
<div class="card card-warning">
    <div class="card-header"><i class="fa fa-list"></i>
      <h3 class="card-title"><strong>DETAIL PRODUK</strong></h3>
      <!-- tools box -->
    <div class="pull-right box-tools"> 
      <!-- button with a dropdown -->
    <div class="btn-group"> </div>
