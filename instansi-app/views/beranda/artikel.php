                                                        ...
                                                        <td class="aksi">
                                                            <?php if ($data['boleh_ubah']) : ?>
                                                                ...
                                                                <?php if ($this->CI->cek_hak_akses('h')) : ?>
                                                                    <a href="#" data-href="<?= site_url("web/delete/$data[id]") ?>" class="btn bg-maroon btn-box btn-sm" title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
                                                                <?php endif; ?>
