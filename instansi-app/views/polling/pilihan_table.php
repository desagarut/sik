																...
																<?php foreach ($pilihan as $key => $data): ?>
																	<tr>
																		...
																		<td nowrap>
																			...
																			<?php } ?>
																			<a href="#" data-href="<?= site_url("polling/delete_pilihan/$polling/$data[id]")?>" class="btn bg-maroon btn-flat btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
																			</td>
