...
<div class="pcoded-main-container">
          ...
          <div class="col-md-12">
              <div class="card card-warning">
                <div class="card-header"> <a href="<?= site_url("tawa/form_layanan/$gallery")?>" class="btn btn-box btn-success btn-sm btn-sm "  title="Tambah layanan"> <i class="fa fa-plus"></i> Tambah layanan </a>
                  ...
                  <a href="#confirm-delete" title="Hapus Data" onclick="deleteAllBox('mainform', '<?= site_url("tawa/delete_all_layanan/$gallery")?>')" class="btn btn-box btn-danger btn-sm  hapus-terpilih"><i class='fa fa-trash'></i> Hapus Data Terpilih</a>
                  <?php endif; ?>
  ...
  <div class="card card-warning collapsed-box">
        <div class="card-header"> <i class="fa fa-calendar"></i>
          <h3 class="card-title"><strong>INFO UMKM</strong></h3>
          <!-- tools box -->
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td nowrap><a href="<?=site_url("tawa/urut/$data[id]/1/$sub[id]")?>" class="btn bg-olive btn-box btn-sm"  title="Pindah Posisi Ke Bawah"><i class="fa fa-arrow-down"></i></a> <a href="<?=site_url("tawa/urut/$data[id]/2/$sub[id]")?>" class="btn bg-olive btn-box btn-sm"  title="Pindah Posisi Ke Atas"><i class="fa fa-arrow-up"></i></a>
                            ...
                            <br/>
                            <?php if ($this->CI->cek_hak_akses('h')): ?>
                            <a href="<?= site_url("tawa/form_layanan/$gallery/$data[id]")?>" class="btn btn-warning btn-box btn-sm"  title="Ubah"><i class="fa fa-edit"></i></a> <a href="#" data-href="<?= site_url("tawa/delete_layanan/$gallery/$data[id]")?>" class="btn bg-maroon btn-box btn-sm"  title="Hapus" data-toggle="modal" data-target="#confirm-delete"><i class="fa fa-trash"></i></a>
                            <?php endif; ?></td>
