...
class Setting_model extends CI_Model {
	...
	private function apply_setting()
	{
		...
		// Ambil google api key dari instansi/config/config.php kalau tidak ada di database
		if (empty($this->setting->google_key))
		{
			$this->setting->google_key = config_item('google_key');
		}
		// Ambil token tracksid dari instansi/config/config.php kalau tidak ada di database
		if (empty($this->setting->token_sidega))
		{
			$this->setting->token_sidega = config_item('token_sidega');
		}
		// Ambil dev_tracker dari instansi/config/config.php kalau tidak ada di database
