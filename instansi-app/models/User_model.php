...
class User_model extends CI_Model {
	...
	public function hak_akses($group, $controller, $akses)
	{
		...
		$hak_akses = array(
			...
			20 => array(
				...
				//Perencanaan Desa
				'perencanaan_desa' => array('b','u','h'),
				'perencanaan_desa_program_masuk_desa' => array('b','u','h'),
				'perencanaan_desa/usulan_dusun' => array('b','u','h'),
				
				//Perencanaan Kecamatan
				'perencanaan_kecamatan' => array('b','u','h'),
				'perencanaan_kecamatan_polling/daftar_polling' => array('b','u','h'),
				'perencanaan_kecamatan/rptk' => array('b','u','h'),
				...
				// wilayah
				'man_user' => array('b','u','h'),
				'database' => array('b','u','h'),
			),
  ...
  // Key disimpan di $this->session->fm_key yg dipasang di setting tinymce
	// dan di tempat memanggil filemanager, seperti di instansi-app/views/setting/setting_qr.php.
