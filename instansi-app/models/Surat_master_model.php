<?php class Surat_master_model extends MY_Model {
	...
	public function insert()
	{
		...
		$folder_surat = LOKASI_SURAT_INSTANSI.$data['url_surat']."/";
	...
	public function upload($url="")
	{
		...
		$folder_surat = LOKASI_SURAT_INSTANSI.$url."/";
		if (!file_exists($folder_surat))
		{
	...
	// Lampiran surat perlu disalin ke folder surata di LOKASI_SURAT_INSTANSI, karena
  ...
  public function get_kode_isian($surat)
  {
    ...
    $path_lokal = FCPATH . LOKASI_SURAT_INSTANSI .$surat['url_surat']."/".$surat['url_surat'].".php";
	...
	{
		$folder_surat_desa = glob(LOKASI_SURAT_INSTANSI.'*' , GLOB_ONLYDIR);
		foreach ($folder_surat_desa as $surat)
		{
			$surat = str_replace(LOKASI_SURAT_INSTANSI, '', $surat);
